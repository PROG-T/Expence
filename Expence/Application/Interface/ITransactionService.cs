...
namespace Expence.Application.Interface
{
    public interface ITransactionService
    {
        ...
        Task<BaseResponse<Transaction>> DeleteTransactionAsync(string transactionReference, long userId);
        ...
        Task<BaseResponse<List<Transaction>>> GetAllTransactionByUserIdAsync(TransactionQueryRequest request);
    }
}
